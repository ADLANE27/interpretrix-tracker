...
serve(async (req) => {
  try {
    ...
    console.log('[Push Webhook] Received payload:', payload);
    ...
    const results = await Promise.allSettled(
      subscriptions.map(async (sub) => {
        try {
          ...
          console.log('[Push Webhook] Sending to:', sub.endpoint);
          ...
          console.error('[Push Webhook] Send error:', error);
    ...
    console.log('[Push Webhook] Results:', JSON.stringify(summary));
