...
export const DashboardContent = ({
  ...
  return (
    <div className="flex-1 overflow-auto h-full pb-16 bg-gradient-to-br from-white via-palette-soft-blue/10 to-palette-soft-purple/20 dark:from-gray-900 dark:via-palette-ocean-blue/10 dark:to-palette-vivid-purple/10">
