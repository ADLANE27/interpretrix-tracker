...
export const MessagingTab = () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-3 sm:gap-6 h-[calc(100dvh-300px)] min-h-[400px] relative">
      {(!selectedChannelId || showChannels || !isMobile) && (
        <Card className={cn(
          ...
          isMobile && "fixed inset-0 z-50 m-0 rounded-none h-[100dvh]"
        )}>
