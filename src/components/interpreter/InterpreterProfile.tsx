      ...
      <div className="grid gap-6 pb-8">
        <Card className="border-0 shadow-none bg-[#F1F0FB]">
          ...
          <CardContent className="grid gap-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label className="text-[#403E43]">Pays de naissance</Label>
                <Input type="text" value={profile.birth_country || ''} readOnly className="border-0 bg-white shadow-sm" />
              </div>
              <div className="grid gap-2">
                <Label className="text-[#403E43]">Nationalité</Label>
        ...
        <Card className="border-0 shadow-none bg-[#F1F0FB]">
          <CardHeader>
            <CardTitle className="text-[#403E43]">Informations professionnelles</CardTitle>
            <CardDescription>Consulter vos informations professionnelles.</CardDescription>
          </CardHeader>
          <CardContent className="grid gap-4">
            <div className="grid gap-2">
              <Label className="text-[#403E43]">Statut professionnel</Label>
              <Input 
                type="text" 
                value={
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="grid gap-2">
                <Label className="text-[#403E43]">Numéro SIRET</Label>
                <Input type="text" value={profile.siret_number || ''} readOnly className="border-0 bg-white shadow-sm" />
              </div>
              <div className="grid gap-2">
                <Label className="text-[#403E43]">Numéro de TVA</Label>
        ...
        <Card className="border-0 shadow-none bg-[#F1F0FB]">
          <CardHeader>
            <CardTitle className="text-[#403E43]">Langues</CardTitle>
            ...
            <div className="space-y-2">
              {profile.languages.map((lang, index) => (
                <div key={index} className="flex items-center gap-2">
                  <Badge variant="secondary" className="bg-white shadow-sm">{lang.source}</Badge>
                  <span>→</span>
                  <Badge variant="secondary" className="bg-white shadow-sm">{lang.target}</Badge>
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <Card className="border-0 shadow-none bg-[#F1F0FB]">
          <CardHeader>
            <CardTitle className="text-[#403E43]">Photo de profil</CardTitle>
          ...
          <CardContent className="grid gap-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="space-y-2">
                <Button variant="secondary" onClick={() => document.getElementById('profile-picture-input')?.click()} className="shadow-sm">
                ...
                />
                {profile.profile_picture_url && (
                  <Button variant="destructive" onClick={onProfilePictureDelete} className="shadow-sm">
                    Supprimer la photo
                  </Button>
                )}
              </div>
