        ...
        <div className={cn(
          ...
          {showScrollButton && (
            <Button
              ...
              className="fixed bottom-[180px] right-8 rounded-full shadow-lg bg-white hover:bg-gray-100 z-10"
              size="icon"
              variant="outline"
            >
          ...
          <div className="sticky bottom-0 left-0 right-0 bg-white border-t shadow-lg mt-auto">
            <div className="p-4">
              <div className="relative rounded-lg border bg-[#F8F9FA] shadow-sm transition-all hover:shadow-md">
                ...
                <Textarea
                  ...
                  className="min-h-[80px] max-h-[200px] resize-none border-0 focus-visible:ring-0 rounded-lg bg-transparent px-4 py-3 text-[15px] leading-relaxed placeholder:text-gray-500"
                />
