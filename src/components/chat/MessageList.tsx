    ...
    >
      ...
      <div className={`flex-1 max-w-[75%] space-y-1.5 ${
        ...
        <div className={`group relative ${
          ...
          {/* Timestamp repositionné pour mieux s'adapter aux icônes d'action */}
          ...
          {/* Actions pour mobile et desktop avec positionnement amélioré */}
          {(message.sender.id === currentUserId || setReplyTo) && (
            <div className={isMobile 
              ? "absolute right-3 top-3 flex items-center gap-2 bg-white/90 dark:bg-gray-700/90 rounded-full p-1 shadow-sm" 
              : "absolute right-0 top-1/2 -translate-y-1/2 translate-x-full flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity pl-2"
            }>
              {message.sender.id === currentUserId && (
                <button
