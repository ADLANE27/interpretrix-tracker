...
export const TabNavigationPanel: React.FC<TabNavigationPanelProps> = ({
  ...
  return <div className="flex justify-between items-center sticky top-0 backdrop-blur-sm z-20 px-4 border-b border-[#2a3854] shadow-sm bg-slate-50 sm:px-0 py-[40px]">
